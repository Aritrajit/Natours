...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/aritra007/clj09c5po001801miffhdbm5g',
    // style URL
    scrollZoom: false
...
var showAlert = function showAlert(type, message) {
  hideAlert(); // to hide all existing alerts
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            ...
            data: {
              email: email,
              //the email(here is the field in the backend the expects the data): email (is the parameter passed)
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.data.status = 'success') {
            (0, _alerts.showAlert)('success', 'Loggedout succesfully');
      ...
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            ...
            data: {
              name: name,
              //the name(here is the field in the backend the expects the data): name (is the parameter passed)
              email: email,
              //the email(here is the field in the backend the expects the data): email (is the parameter passed)
              password: password,
              //the password(here is the field in the backend the expects the data): password (is the parameter passed)
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Data updated succesfully"));
            location.reload();
          }
          _context.next = 11;
          break;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe("pk_test_51NMYEISFCwtNkN2Q6ENbXOzq4GzSKyhJmqWjzzd5bOwi23mwjLs6mMtdiL6pRqexj7EV8vS1QAErA1xKjRJzT8Le004172oMDV");
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSettings)(form, 'data'); //form is send as an object 
  });
}
